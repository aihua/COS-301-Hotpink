...
%%%%%%%%%%%%%%%%%%%%%%======================   USE CASES   ================%%%%%%%%%%%%%%%%
	...
	%%%%%%%%%%%%%%%%%%%%%%======================   UC1    ================%%%%%%%%%%%%%%%%
		...
		\begin{figure}[h]
		\caption{Use Case Diagram -  Navigate user to their desired location}
		...
		\graphicspath{ {./Images/User/} }
		\begin{figure}[h]
		\caption{Use Case Diagram -   Obtain Current Location}
	 ...
	 \graphicspath{ {./Images/User/} }
		\begin{figure}[h]
		\caption{Use Case Diagram -    Search for location}
		...
		\end{table}
 		\graphicspath{ {./Images/User/} }
		\begin{figure}[h]
		\caption{Use Case Diagram -  Calculate the estimated time of arrival}
		...
		\graphicspath{ {./Images/User/} }
		\begin{figure}[h]
		\caption{Use Case Diagram -  Provide special routes for users with disabilities}
